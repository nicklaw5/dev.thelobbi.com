...
if (!DevExpress.MOD_WIDGETS_BASE) {
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent(SCROLLABLE, DX.DOMComponent.inherit({
            ...
            scrollToElement: function(element) {
                var $element = $(element);
                if (!$element.length || !this._element().find($element).length)
                    return;
                var position = {
                        top: 0,
                        left: 0
            ...
            _elementPosition: function($element, direction) {
                var elementPosition = $element.position()[direction === VERTICAL ? 'top' : 'left'];
    ...
    (function($, DX, undefined) {
        ...
        var SCROLLVIEW_PULLDOWN_REFRESHING_CLASS = "dx-scrollview-pull-down-loading",
            ...
            STATE_REFRESHING = 2,
            STATE_LOADING = 3;
        var SCROLLVIEW_CONTENT_PADDING = 2;
        var PullDownNativeScrollViewStrategy = ui.NativeScrollableStrategy.inherit({
                ...
                _pushBackFromBoundary: function() {
                    var scrollTopPos = this._$container.scrollTop(),
                        scrollBottomPos = this._scrollOffset + scrollTopPos - SCROLLVIEW_CONTENT_PADDING;
                    if (!scrollTopPos)
                        this._$container.scrollTop(1);
                    else if (!scrollBottomPos)
                        this._$container.scrollTop(1 - this._scrollOffset)
                },
                ...
                location: function() {
                    return {
                            left: -this._$container.scrollLeft(),
                            top: 1 - this._$container.scrollTop()
                        }
                },
                scrollBy: function(distance) {
                    var location = this.location();
                    this._$container.scrollTop(-location.top - distance.top + 1);
                    this._$container.scrollLeft(-location.left - distance.left)
                },
                dispose: function() {
                    clearTimeout(this._pullDownRefreshTimeout);
        ...
        DX.registerComponent("dxDropDownEditor", ui.dxTextBox.inherit({
            ...
            _attachButtonEvents: function() {
                ...
                if (!this.option("readOnly")) {
                    ...
                    this._button.on(DROP_DOWN_EDITOR_DXCLICK_EVENT_NAME, function(e) {
                        dxClickAction({jQueryEvent: e})
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxRadioGroup", ui.CollectionContainerWidget.inherit({
            ...
            _setIndexByItem: function(item) {
                var selectedIndex = -1;
                $.each(this.option("items"), $.proxy(function(index, dataSourceItem) {
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxList", ui.CollectionContainerWidget.inherit({
            ...
            scrollToItem: function(itemElement) {
                this._scrollView.scrollToElement(itemElement)
            }
        }))
    })(jQuery, DevExpress);
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxList", ui.dxList.inherit({
            ...
            _updateSelectedItems: function() {
                ...
                var unselected = removeDublicates(oldSelection, newSelection);
                $.each(unselected, function(_, normalizedIndex) {
                    that._unselectItem(normalizedIndex)
                });
                var selected = removeDublicates(newSelection, oldSelection);
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxLookup", ui.dxEditor.inherit({
            ...
            _renderField: function() {
                var that = this,
                    fieldClickAction = this._createAction(this._handleFieldClick);
