    ...
    @section('content')
        <div class="feature-container">
            ...
            <!-- <div class="feature-container-inner"> -->
                ...
                <a href="#" class="feature-minor minor-top">
                    <div class="feature-overlay">
                        <div class="feature-minor-meta">
                            <span><strong>Assassin's Creed: Unity</strong></span>
                            <h4>Assassin's Creed Unity and Rogue plots revealed, release date set for Nov. 11</h4>    
                        </div>
                    </div>
                </a> 
                <a href="#" class="feature-minor minor-bottom">
                    <div class="feature-overlay">
                        <div class="feature-minor-meta">
                            <span><strong>Assassin's Creed: Unity</strong></span>
                            <h4>Assassin's Creed Unity and Rogue plots revealed, release date set for Nov. 11</h4>    
