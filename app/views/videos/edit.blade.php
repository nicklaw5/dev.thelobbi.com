				...
				{{ Form::open(['method' => 'PUT', 'action' => array('VideosController@update', $video->id)]) }}
					...
					<div class="form-group row">
						<div class="col-sm-12">
							...
							{{ Form::textarea('description', $video->description, ['id' => 'description', 'required', 'rows' => '3', 'class' => 'form-control autogrow', 'placeholder' => 'eg. Revolution is in the air in Assassin\'s Creed: Unity. Are you ready to write history?']) }}
					...
					<div class="form-group row col-sm-12">
						<button type="submit" class="btn btn-secondary">Update Video</button>
