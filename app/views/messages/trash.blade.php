		...
		<div class="col-sm-9 mailbox-right">
			...
			<div class="mail-env">
				<div class="panel-heading">
					<h3 class="">Trashed Messages</h3>
					@if( count($messages) === 0 )
					<p class="col-sm-12">There's no trash here.</p>
					@endif
				</div>
					...
					<table class="table mail-table">
							...
							<tr>
								...
								<th colspan="4" class="col-header-options">
									<div style="float:left">
										<button id="returnBtn" type="button" class="btn btn-small btn-primary">Return to Inbox</button>
						...
						<tbody>
							...
							<tr>
								...
								<td class="col-name">
									<a href="{{ url('admin/messages/'.$message->id.'/received') }}" class="col-name">{{ $message->recipient }}</a>
								</td>
...
<script src="{{ URL::asset('assets/js/messages-recipient-delete.js') }}"></script>
<script src="{{ URL::asset('assets/js/messages-return-trash.js') }}"></script>
