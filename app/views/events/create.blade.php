	...
	<div class="col-sm-6">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				{{ Form::open(['action' => 'GamingEventsController@store']) }}
					...
					<div class="form-group row">
						<div class="col-sm-12">
							...
							{{ Form::text('event', '', ['class' => 'form-control', 'required', 'placeholder' => 'eg. E3 2014']) }}
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-sm-12">
							...
							{{ Form::textarea('description', '', ['id' => 'description', 'rows' => '4', 'class' => 'form-control autogrow', 'placeholder' => 'eg. E3 (or Electronic Entertainment Expo) is the must-attend event where the video game industry unites to debut, showcase, and experience the future of games.']) }}
					...
					<div class="form-group row">	
						<div class="form-group col-sm-6">
							...
							<div class="input-group">
								{{ Form::text('start_date', '', ['required', 'class' => 'form-control datepicker', 'data-start-view' => '1', 'data-format' => 'dd MM yyyy']) }}
						...
						<div class="form-group col-sm-6">
							...
							<div class="input-group">
								{{ Form::text('end_date', '', ['required', 'class' => 'form-control datepicker', 'data-start-view' => '1', 'data-format' => 'dd MM yyyy']) }}
								<div class="input-group-addon">
									<a href="#"><i class="linecons-calendar"></i></a>
								</div>
							</div>
