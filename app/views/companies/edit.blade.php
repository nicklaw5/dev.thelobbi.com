				...
				{{ Form::open(['method' => 'PUT', 'action' => array('CompaniesController@update', $company->id) ]) }}
					...
					<div class="form-group row">
						<div class="col-sm-12">
							...
							{{ Form::textarea('description', $company->description, ['id' => 'description', 'rows' => '4', 'class' => 'form-control autogrow']) }}
					...
					<div class="form-group row">
						<div class="col-sm-12">
							...
							{{ Form::text('logo', $company->logo, ['id' => 'logo', 'class' => 'form-control', 'placeholder' => 'eg. http://static.thelobbi.com/uploads/companies/ea-sports-logo.jpg']) }}
						</div>
					</div>
