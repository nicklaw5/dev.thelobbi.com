		...
		{{ Form::open(['action' => 'CompaniesController@store']) }}
			...
			<div class="form-group row">
				<div class="col-lg-6">
					...
					{{ Form::textarea('description', '', ['rows' => '4', 'class' => 'form-control autogrow', 'placeholder' => 'eg. Electronic Arts is a leading global interactive entertainment software company. EA delivers games, content and online services for Internet-connected consoles, personal computers, mobile phones and tablets.']) }}
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-lg-5">
					...
					{{ Form::text('logo', '', ['id' => 'logo', 'class' => 'form-control', 'placeholder' => 'Click the button to add some box art.']) }}
				</div>
				<div class="col-lg-1">
			...
			<div style="margin-top:50px;" class="form-group row col-lg-3">
				<button type="submit" class="btn btn-green">Save New Company</button>
			</div>
