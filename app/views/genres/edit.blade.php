	...
	<div class="col-sm-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Edit Genre</h6>
			</div>
				...
				{{ Form::open(['method' => 'PUT', 'action' => array('GenresController@update', $genre->id)]) }}
					...
					<div class="form-group row">
						<div class="col-sm-12">
							...
							{{ Form::textarea('description', $genre->description, ['id' => 'description', 'rows' => '4', 'class' => 'form-control autogrow']) }}
					...
					<div class="form-group row col-sm-12">
						<button type="submit" class="btn btn-secondary">Update Genre</button>
