...
<head>
	...
	<link rel="stylesheet" href="{{ URL::asset('assets/css/xenon-skins.css') }}">
					...
					<div class="user-info">
						...
						<div class="user-image">
							<a href="extra-profile.html">
								<img src="{{ URL::asset('assets/images/user-2.png" class="img-responsive img-circle') }}" />
							</a>
						</div>
