...
<div class="alert alert-success col-lg-6">
	<div class="row">			
		<div style="margin-bottom: 0">
			<div class="col-xs-11">
				<p style="margin:0;">{{ Session::pull('adminSuccessAlert') }}</p>
			</div>
			<div class="col-xs-1">	
...
<div class="alert alert-warning col-lg-6">
	<div class="row">			
		<div style="margin-bottom: 0">
			<div class="col-xs-11">
				<p style="margin:0;">{{ Session::pull('adminWarningAlert') }}</p>
			</div>
			<div class="col-xs-1">	
				<h4><a href="Javascript:;" onclick="jQuery('.alert').hide();"><i style="float:right" class="entypo-cancel"></i></a></h4>
			</div>
...
<div class="alert alert-danger col-lg-6">
	<div class="row">			
		<div style="margin-bottom: 0">
			<div class="col-xs-11">
				<p style="margin:0;">{{ Session::pull('adminDangerAlert') }}</p>
			</div>
			<div class="col-xs-1">	
				<h4><a href="Javascript:;" onclick="jQuery('.alert').hide();"><i style="float:right" class="entypo-cancel"></i></a></h4>
			</div>
...
<div class="alert alert-info col-lg-6">
	<div class="row">			
		<div style="margin-bottom: 0">
			<div class="col-xs-11">
				<p style="margin:0;">{{ Session::pull('adminInfoAlert') }}</p>
			</div>
			<div class="col-xs-1">	
				<h4><a href="Javascript:;" onclick="jQuery('.alert').hide();"><i style="float:right" class="entypo-cancel"></i></a></h4>
			</div>
